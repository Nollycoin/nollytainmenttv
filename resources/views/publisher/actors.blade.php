...
@section('navbar-brand')
    <a class="navbar-brand" href="#">
        Actors
        <a href="{{ route('_publisher_add_actor') }}" class="btn btn-success btn-fill btn-xs pull-left" style="margin-top:21px;">
            ...
            @if(!empty($actors))
                @foreach($actors as $actor)
                    <div class="actor-card">
                        ...
                        <div class="edit"><a href="{{ route('publisher_edit_actor', ['id' => $actor->id]) }}"><i class="ti-pencil"></i></a>
                        </div>
