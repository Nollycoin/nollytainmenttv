...
@section('body')
    <div class="content">
        <div class="container-fluid">
            ...
            @if(Session::has('actors') && !empty(Session::get('actors')))
                <div class="card">
                    <div class="header">
                        ...
                        @foreach(Session::get('actors') as $actor)
                            <div class="actor-card" id="actor-{{ $actor->id }}">
                                ...
                                <div class="edit" title="Add this actor">
                                    <a href="#" onclick="addActorFromExisting('{{ $actor->id }}')">
                                        <i class="ti-plus"></i>
                                    </a>
                                </div>
                ...
                <div class="card">
                    ...
                    <div class="content">
                        ...
                        <form action="{{ route('_save_actor') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="pull-left">
                                <button type="submit" name="add" class="btn btn-success btn-fill btn-wd">Add Actor
                                </button>
                            </div>
                            <div class="clearfix"></div>
                        </form>
