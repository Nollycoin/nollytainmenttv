...
@section('navbar-brand')
    <a class="navbar-brand" href="#">
        Videos
        <a href="{{ route('_publisher_add_video') }}" class="btn btn-success btn-fill btn-xs pull-left" style="margin-top:21px;">
            ...
            @if(!empty($movies))
                @foreach($movies as $movie)
                    <div class="video-card">
                        ...
                        <div class="edit"><a href="{{ route('_publisher_edit_video', ['id'=> $movie->id ]) }}"><i class="ti-pencil"></i></a>
                        </div>
